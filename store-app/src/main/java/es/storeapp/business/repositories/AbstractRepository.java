...
public abstract class AbstractRepository<T> {
    ...
    private static final String FIND_ALL_ORDERED_QUERY = "SELECT t FROM {0} t ORDER BY t.:p";
    private static final String FIND_BY_TEXT_ATTRIBUTE_QUERY = "SELECT t FROM {0} t WHERE t.:p1 = :p2 ORDER BY t.:p3";
    ...
    public List<T> findAll(String orderColumn) {
        Query query = entityManager.createQuery(FIND_ALL_ORDERED_QUERY);
        query.setParameter("p",orderColumn);
        return query.getResultList();
    }
    ...
    public List<T> findByStringAttribute(String attribute, String value, String orderColumn) {
        ...
        query.setParameter("p1",attribute);
        query.setParameter("p2",value);
        query.setParameter("p3",orderColumn);
        return query.getResultList();
    }
}
